...
test.describe("FormControl Component", () => {
  ...
  test("should prioritize error message over helper text", async ({
    mount,
  }) => {
    const component = await mount(
      <FormControl helperText="Helper text" error errorMessage="Error message">
        <input type="text" />
      </FormControl>,
    );
  ...
  test("should pass accessibility checks", async ({ mount, page }) => {
    await mount(
      <div>
        ...
        <FormControl label="Password" htmlFor="password-1" required>
