...
test.describe("Select Component", () => {
  ...
  test("should render different variants in desktop mode", async ({
    mount,
  }) => {
    const component = await mount(
      <div>
  ...
  test("should render with label", async ({ mount }) => {
    const component = await mount(
      <Select label="Country" options={testOptions} forceMobile={false} />,
    );
  ...
  test("should render all options in mobile mode", async ({ mount }) => {
    const component = await mount(
      <Select options={testOptions} placeholder="Select" forceMobile={true} />,
    );
  ...
  test("should handle value change in desktop mode", async ({
    mount,
    page,
  }) => {
    let selectedValue = "";
  ...
  test("should pass accessibility checks in desktop mode", async ({
    mount,
    page,
  }) => {
    await mount(
  ...
  test("should pass accessibility checks in mobile mode", async ({
    mount,
    page,
  }) => {
    await mount(
  ...
  test("should support keyboard navigation in desktop mode", async ({
    mount,
    page,
  }) => {
    const component = await mount(
