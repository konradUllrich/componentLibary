...
test.describe("ReactSelect Component", () => {
  ...
  test("should support keyboard navigation - Space to open", async ({
    mount,
    page,
  }) => {
    const component = await mount(
  ...
  test("should support keyboard navigation - Enter to open", async ({
    mount,
    page,
  }) => {
    const component = await mount(
  ...
  test("should support keyboard navigation - Escape to close", async ({
    mount,
    page,
  }) => {
    const component = await mount(
  ...
  test("should render disabled items", async ({ mount, page }) => {
    const component = await mount(
      <ReactSelect placeholder="Select">
        <ReactSelectItem value="1">Option 1</ReactSelectItem>
        <ReactSelectItem value="2" disabled>
          Option 2 (Disabled)
        </ReactSelectItem>
  ...
  test("should pass accessibility checks", async ({ mount, page }) => {
    ...
    // Disable color-contrast for Radix-generated content
    // Disable button-name as Radix Select trigger button accessibility is handled via aria-labelledby
    await checkA11y(page, { disableRules: ["color-contrast", "button-name"] });
  });
  ...
  test("should show selected indicator on selected item", async ({
    mount,
    page,
  }) => {
    const component = await mount(
