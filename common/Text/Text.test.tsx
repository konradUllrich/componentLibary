...
test.describe('Text Component', () => {
  ...
  test('should render as different HTML elements', async ({ mount }) => {
    const component = await mount(
      <div>
        <Text as="p" data-testid="paragraph">Paragraph</Text>
        <Text as="span" data-testid="span">Span</Text>
        <Text as="div" data-testid="div">Div</Text>
        <Text as="h1" data-testid="h1">Heading 1</Text>
        <Text as="h2" data-testid="h2">Heading 2</Text>
        <Text as="h3" data-testid="h3">Heading 3</Text>
        <Text as="h4" data-testid="h4">Heading 4</Text>
        <Text as="h5" data-testid="h5">Heading 5</Text>
        <Text as="h6" data-testid="h6">Heading 6</Text>
        <Text as="label" data-testid="label">Label</Text>
      </div>
    );
    
    await expect(component.locator('[data-testid="paragraph"]')).toContainText('Paragraph');
    await expect(component.locator('[data-testid="span"]')).toContainText('Span');
  ...
  test('should pass accessibility checks', async ({ mount, page }) => {
    await mount(
      <div>
        <Text as="h1" size="3xl" weight="bold">Main Heading</Text>
        <Text as="h2" size="2xl" weight="semibold">Sub Heading</Text>
        <Text as="p" size="base">Regular paragraph text</Text>
        <Text as="span" color="secondary">Secondary text</Text>
      </div>
    );
  ...
  test('should pass accessibility checks with color variants', async ({ mount, page }) => {
    await mount(
      <div>
  ...
  test.describe('Visual States', () => {
    ...
    test('should render semantic headings with appropriate sizes', async ({ mount }) => {
      const component = await mount(
        <div>
          <Text as="h1" size="3xl" weight="bold">H1 Title</Text>
          <Text as="h2" size="2xl" weight="semibold">H2 Title</Text>
          <Text as="h3" size="xl" weight="semibold">H3 Title</Text>
        </div>
      );
