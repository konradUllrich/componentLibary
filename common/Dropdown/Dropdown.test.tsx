  ...
  test('should handle item selection', async ({ mount, page }) => {
    ...
    await mount(
      <Dropdown>
        ...
        <DropdownContent>
          <DropdownItem onSelect={() => { selectedItem = 'Item 1'; }}>
            Item 1
          </DropdownItem>
          <DropdownItem onSelect={() => { selectedItem = 'Item 2'; }}>
            Item 2
          </DropdownItem>
        </DropdownContent>
      </Dropdown>
  ...
  test('should handle disabled items', async ({ mount, page }) => {
    ...
    await mount(
      <Dropdown>
        ...
        <DropdownContent>
          <DropdownItem disabled onSelect={() => { selectedItem = 'Disabled'; }}>
            Disabled Item
          </DropdownItem>
          <DropdownItem onSelect={() => { selectedItem = 'Enabled'; }}>
            Enabled Item
          </DropdownItem>
        </DropdownContent>
      </Dropdown>
