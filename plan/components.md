...
1. Add `mp-` prefix to all CSS classes (`.label` → `.mp-label`, `.mp-label__required` → `.mp-mp-label__required`, etc.) and update all usages in `Label.tsx`.
...
_Last updated: 2026-03-22 (reviewed for accuracy)_
